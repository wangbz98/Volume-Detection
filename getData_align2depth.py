...
def stream_config():
    ...
    # 如果从bag文件中读取，加上文件路径
    rs.config.enable_device_from_file(config, './data/0000136.bag')
...
def getData_align2depth(save_path, NO):

    try:

        # 配置图像流
        pipeline, profile, align = stream_config()
